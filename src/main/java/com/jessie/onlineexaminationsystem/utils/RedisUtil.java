package com.jessie.onlineexaminationsystem.utils;
...
public class RedisUtil {
    ...
    public Cursor<Map.Entry<Object, Object>> hScan(String key, ScanOptions options) {
        return redisTemplate.opsForHash().scan(key, options);//Map.Entry是一个类似于Pair的玩意，但是可以用来迭代map
        //总之这个是返回符合条件的key和value.options中可以设置NULL（全部迭代），也可以设置count（位置）/match（匹配）来迭代
    }
